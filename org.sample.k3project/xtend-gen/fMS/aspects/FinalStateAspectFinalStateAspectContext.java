...
import fMS.aspects.FinalStateAspectFinalStateAspectProperties;
...
public class FinalStateAspectFinalStateAspectContext {
  ...
  public static FinalStateAspectFinalStateAspectProperties getSelf(final FinalState _self) {
    		if (!INSTANCE.map.containsKey(_self))
    			INSTANCE.map.put(_self, new fMS.aspects.FinalStateAspectFinalStateAspectProperties());
    		return INSTANCE.map.get(_self);
  }
  
  private Map<FinalState, FinalStateAspectFinalStateAspectProperties> map = new java.util.WeakHashMap<fMS.FinalState, fMS.aspects.FinalStateAspectFinalStateAspectProperties>();
